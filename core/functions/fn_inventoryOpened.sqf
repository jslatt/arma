...
// Disables Backpacks to be seen or heard... like mah dick - Dante
if (side player == independent) then { unitBackpack player setObjectTextureGlobal [0,""]} ;
if (side player == west) then { unitBackpack player setObjectTextureGlobal [0,""]} ;