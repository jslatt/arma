/*
   Uploaded to altisLifeRPG by Repentz
   Creator: Papabear
*/
...
switch (_slot) do
{
    case 111:{_winnings = 16000;};
    case 110:{_winnings = 3200;};
    case 123:{_winnings = 3600;};
    case 211:{_winnings = 3200;};
    case 123:{_winnings = 3200;};
    case 234:{_winnings = 3200;};
    case 345:{_winnings = 36000;};
    case 456:{_winnings = 4400;};
    case 567:{_winnings = 4800;};
    case 311:{_winnings = 3200;};
    case 411:{_winnings = 3200;};
    case 511:{_winnings = 3200;};
    case 611:{_winnings = 3200;};
    case 110:{_winnings = 3200;};
    case 112:{_winnings = 3200;};
    case 113:{_winnings = 3200;};
    case 114:{_winnings = 3200;};
    case 115:{_winnings = 3200;};
    case 116:{_winnings = 3200;};
    case 121:{_winnings = 2400;};
    case 131:{_winnings = 2400;};
    case 141:{_winnings = 2400;};
    case 151:{_winnings = 2400;};
    case 171:{_winnings = 2400;};
    case 121:{_winnings = 2400;};
    case 222:{_winnings = 12000;};
    case 333:{_winnings = 8000;};
    case 444:{_winnings = 8000;};
    case 555:{_winnings = 6000;};
    case 666:{_winnings = 100000;};
    case 777:{_winnings = 180000;};
    default {_winnings = 0;}
};
