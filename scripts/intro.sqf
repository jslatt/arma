...
_role1 = "Welcome To";
_role1names = ["Dark Gaming"];
_role2 = "Version:";
_role2names = ["Dark Gaming Version 3.30"];
_role3 = "Owner:";
_role3names = ["Bucket Smith","Twisty"];
_role4 = "Developers:";
_role4names = ["Needed"];
_role5 = "Admins:";
_role5names = ["James Shark","Cali White","Peeta Mellark","i3itCoin","Wolfy"];
_role6 = "Moderators:";
_role6names = ["James Maki","Devil Kitty","Daichi","A.Garza","Rem"];
_role7 = "Website:";
