...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
			...
			{ "U_B_CombatUniform_mcam", "SWAT Uniform", 1, { "life_coplevel", "SCALAR", 4 } },
        ...
        headgear[] = {
            ...
            { "H_Cap_police", "", 1, { "", "", -1 } },
            { "H_Watchcap_blk", "", 1, { "", "", -1 } },
			{ "H_Beret_blk_POLICE", "", 1, { "life_coplevel", "SCALAR", 4 } },
            { "H_HelmetSpecB_blk", "", 1, { "life_coplevel", "SCALAR", 5 } },
            { "H_Booniehat_mcamo", "", 1, { "life_coplevel", "SCALAR", 5 } },
            { "H_Beret_Colonel", "", 1, { "life_coplevel", "SCALAR", 6 } }
        };
        goggles[] = {
        ...
        vests[] = {
            { "NONE", "Remove Vest", 0, { "", "", -1 } },
            { "V_PlateCarrierH_CTRG", "", 1, { "", "", -1 } },
			{ "V_PlateCarrier2_blk", "", 1, { "life_coplevel", "SCALAR", 4 } },
            { "V_RebreatherB", "", 1, { "", "", -1 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
    ...
    class cop_swat {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_B_CTRG_Soldier_F", "SWAT Standard", 350, { "life_donorlevel", "SCALAR", 69 } },
            { "U_B_CTRG_Soldier_2_F", "SWAT Standard Tee", 550, { "life_donorlevel", "SCALAR", 69 } },
            { "U_B_CTRG_Soldier_3_F", "SWAT Standard Roll-up", 1250, { "life_donorlevel", "SCALAR", 69 } },
            { "U_B_CTRG_Soldier_urb_1_F", "Urban Standard", 1250, { "life_donorlevel", "SCALAR", 69 } },
            { "U_B_CTRG_Soldier_urb_3_F", "Urban Roll-up", 1250, { "life_donorlevel", "SCALAR", 69 } },
            { "U_B_HeliPilotCoveralls", "Air Crew Uniform", 1250, { "life_donorlevel", "SCALAR", 69 } },
            { "U_B_GhillieSuit", "Standard Snipper Ghillie", 1250, { "life_donorlevel", "SCALAR", 69 } },
            { "U_B_FullGhillie_sard", "", 1250, { "life_donorlevel", "SCALAR", 69 } },
            { "U_B_FullGhillie_ard", "", 1250, { "life_donorlevel", "SCALAR", 69 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Beret_blk", "", 25, { "life_donorlevel", "SCALAR", 69 } },
            { "H_HelmetB_TI_tna_F", "", 25, { "life_donorlevel", "SCALAR", 69 } },
            { "H_PilotHelmetHeli_B", "", 25, { "life_donorlevel", "SCALAR", 69 } },
            { "H_CrewHelmetHeli_B", "", 25, { "life_donorlevel", "SCALAR", 69 } },
            { "H_HelmetSpecO_blk", "Spec-OPs Helmet", 75, { "life_donorlevel", "SCALAR", 69 } }
        };
        goggles[] = {
            { "G_Balaclava_TI_blk_F", "", 50, { "life_donorlevel", "SCALAR", 69 } },
            { "G_Balaclava_TI_tna_F", "", 50, { "life_donorlevel", "SCALAR", 69 } },
            { "G_Balaclava_TI_G_blk_F", "", 50, { "life_donorlevel", "SCALAR", 69 } },
            { "G_Balaclava_TI_G_tna_F", "", 50, { "life_donorlevel", "SCALAR", 69 } }
        };
        vests[] = {
            { "NONE", "Remove Vest", 0, { "", "", -1 } },
            { "V_TacVestIR_blk", "Air Vest", 3000, { "life_donorlevel", "SCALAR", 69 } },
            { "V_PlateCarrierSpec_rgr", "Standard Vest Green", 15000, { "life_donorlevel", "SCALAR", 69 } },
            { "V_PlateCarrierSpec_blk", "Standard Vest Black", 20000, { "life_donorlevel", "SCALAR", 69 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
            { "B_UAV_01_backpack_F", "UAV Snipper Drone", 200000, { "life_donorlevel", "SCALAR", 69 } },
            { "B_Bergen_dgtl_F", "Grenadier/Support MTP", 200000, { "life_donorlevel", "SCALAR", 69 } },
            { "B_Bergen_tna_F", "Grenadier/Support MTP", 200000, { "life_donorlevel", "SCALAR", 69 } },
            { "B_ViperHarness_blk_F", "", 3500, { "", "", -1 } },
            { "B_ViperLightHarness_blk_F", "Air Viper Pack", 3500, { "", "", -1 } },
            { "B_Carryall_oli", "Standard Bag", 200000, { "life_donorlevel", "SCALAR", 69 } }
        };
    };
    ...
    class med_clothing {
        ...
        uniforms[] = {
            ...
            { "U_C_WorkerCoveralls", "Medic Uniform", 1, { "life_mediclevel", "SCALAR", 3 } },
            { "U_C_Scientist", "Medic Uniform", 1, { "life_mediclevel", "SCALAR", 4 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_grn_BI", "", 10, { "", "", -1 } },
            ...
            { "H_Beret_Colonel", "Command Beret", 1, { "life_mediclevel", "SCALAR", 4 } }
        ...
        vests[] = {
			...
			{ "V_Rangemaster_belt", "EMS Belt", 1, { "life_mediclevel", "SCALAR", 4 } },
        ...
        backpacks[] = {
			...
			{ "B_Carryall_ghex_F", "Medic Backpack", 1, { "life_mediclevel", "SCALAR", 5 } }
        };
    };
