...
/* System Settings */
    ...
    news_broadcast_cost = 50000000; //Cost for a player to send a news station broadcast.
    news_broadcast_cooldown = 60; //Time in minutes that is required between news station broadcasts. (Default = 20 minutes)
    news_broadcast_header_length = 140; //Number of characters that a header can consist of. Anything over this may clip. This depends on the font size and various other factors. Adjust with caution.
    ...
    escapeMenu_displayText = "Dark Gaming"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    sendtoJail_locations[] = { "cop_spawn_1", "cop_spawn_4", "cop_spawn_3", "cop_spawn_5", "cop_spawn_6", "cop_spawn_2" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    paycheck_civ = 2000; //Payment for civilians
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F","B_Heli_Light_01_armed_F","O_MRAP_02_hmg_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
