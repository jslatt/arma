    ...
    */
    ...
    class med_shop {
        ...
        vehicles[] = {
            { "C_Offroad_01_F", { "", "", -1 } },
            { "C_Van_01_box_F", { "", "", -1 } },
			{ "C_Offroad_02_unarmed_blue_F", { "life_mediclevel", "SCALAR", 4 } },
    ...
    class swat_land {
        ...
        vehicles[] = {
            ...
            { "B_LSV_01_armed_black_F", { "life_coplevel", "SCALAR", 5 } },
            ...
            { "B_APC_Tracked_01_CRV_F", { "life_coplevel", "SCALAR", 5 } },
            { "B_APC_Tracked_01_rcws_F", { "life_coplevel", "SCALAR", 5 } },
    ...
    class swat_air {
        side = "cop";
        vehicles[] = {
            { "B_Heli_Transport_03_black_F", { "life_coplevel", "SCALAR", 4 } },
            { "B_Heli_Transport_01_F", { "life_coplevel", "SCALAR", 4 } },
            { "B_CTRG_Heli_Transport_01_tropic_F", { "life_coplevel", "SCALAR", 4 } },
            { "B_CTRG_Heli_Transport_01_sand_F", { "life_coplevel", "SCALAR", 4 } },
            { "B_T_VTOL_01_infantry_blue_F", { "life_coplevel", "SCALAR", 4 } },
            { "B_T_VTOL_01_vehicle_blue_F", { "life_coplevel", "SCALAR", 4 } },
            { "O_T_VTOL_02_infantry_F", { "life_coplevel", "SCALAR", 4 } },
            { "O_T_VTOL_02_vehicle_F", { "life_coplevel", "SCALAR", 4 } }
        };
    };
...
class LifeCfgVehicles {
    ...
    */
    ...
    class B_MRAP_01_hmg_F {
        ...
        price = 75000;
        textures[] = {
            { "DG SWAT Gun Truck", "cop", {
                "textures\swat_hunter_1.paa",
                "textures\swat_hunter_2.paa",
...
*/
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
            ...
            { "Cop Speed Patrol", "cop", {
                "textures\cop\sporthatch.jpg"
            } }
        };
    };
    ...
    class C_Offroad_02_unarmed_blue_F {
        ...
        textures[] = {
			...
			{ "Medic Jeep", "med", {
                "textures\emsjeep.paa",
                "textures\emsjeep2.paa"
            } },
        };
    };
    ...
    class B_MRAP_01_F {
        ...
        textures[] = {
            ...
            { "Aquaflague Hunter", "don1", {
                "textures\AquaHunter0.jpg",
                "textures\AquaHunterCanvasJPG.jpg"
            } },
            { "Girly Hunter", "don1", {
                "textures\Hunter_pink_front.jpg",
                "textures\Hunter_pink_back.jpg"
            } },
            { "Jungle Hunter", "don2", {
            ...
            { "Desert Hunter", "don2", {
                "textures\Hunter_desert_front_basic_skull.jpg",
                "textures\Hunter_desert_back_basic.jpg"
            } },
        };
    };
