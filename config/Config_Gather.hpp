...
*/
    ...
    class Minerals {
        ...
        class mdma_ecstasy {
            amount = 2; // Amount that will be mined each time.
            zones[] = { "ecstasy_1" }; // Create a mark in editor with this name and place it on the map.
            item = "pickaxe"; // Item required for mine it.
            mined[] = { "mdma_ecstasy" }; // Item that you got. - Already configured in: Config_vItems.hpp - Place the same name of the class here.
            zoneSize = 30;
        };
    };
};