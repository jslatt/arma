...
class VirtualShops {
    ...
    class market {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw", "tobacco_processed" };
    };
    ...
    class drugdealer {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "cocaine_processed", "heroin_processed", "marijuana", "ecstasy" };
    };
...
class VirtualItems {
    ...
    class ecstasy { // Processed
        ...
        sellPrice = 4800; // Same as above. But now it will be the price that you sell for the npcs.
    ...
    class tobacco_unprocessed {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\tobaccounprocess.paa";
