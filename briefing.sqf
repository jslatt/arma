    ...
    player createDiaryRecord ["controls",
        [
            "Police and medic controls",
                "
F: Vehicle siren.<br/>
O: O as in Oscar to open/close bar gates Police (Have to be in vehicle).<br/>
L: Speed radar (police only and weapon is P07 Suppressed).<br/>
Scroll: To get barrier options.<br/>
Space Bar: To place barrier and scroll to remove.<br/>
...
Windows: For Ziptie (Make them surrender and go behind or when knocking out wait till they just wake up).<br/>
...
Left Shift + Insert: Earplug different volumes.<br/><br/>
                "
        ]
    ];
